		...
		<div className="w-full md:px-12 px-6 py-12">
			<div className="grid md:grid-cols-2 ">
				...
				<div className="w-full py-12 relative">
					<img src={about_1} alt="" className="w-full object-cover " />
					<img
						src={about_3}
						alt=""
			...
			<div className="flex flex-col md:flex-row  w-full mt-5 items-center justify-center gap-2">
				<p className="font-caveat font-bold text-[#122f2A]  text-[22px] leading-[22px]  ">
					<span className="font-caveat font-bold text-Orange  text-[22px] mr-2 ">#</span>We Give Donations Poor People Impact on Someone’s Life.
					Donate No
				</p>{" "}
